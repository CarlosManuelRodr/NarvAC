...
SelectColor[coord_,edge_]:=If[edge =!= List,
...
NodeColor[value_]:=White;
NodeColor[{op_,value_}]:=ReplaceAll[{op,value},
{
...
SelectValue[value_]:=value;
SelectValue[{op_,value_}]:=value;

SetOptions[$FrontEndSession,DynamicEvaluationTimeout->20];
PlotInteractiveSystem[system_,plotVertex_:({NodeColor[#2],EdgeForm[Black],Disk[#,.1],Black,Text[SelectValue[#2],#1]}&)]:=DynamicModule[{symbols,controllerSymbols,boxes,controls,plot},
...
MakeReplaceRules[fixed_,toBeReplaced_]:=Map[(vertex_\[DirectedEdge]#):>(vertex\[DirectedEdge]fixed)&,toBeReplaced];
...
CompactExprMatrixPlot[expr_]:=MatrixPlot[AdjacencyMatrix[CompactTreeForm[expr]]];
...
(* ::Input::Initialization:: *)
Bit8AddressCell[dataInput_,writeEnable_,address__,tag_]:=GatedLatch[
dataInput,
writeEnable,
StringJoin[
tag,
...
(* ::Input::Initialization:: *)
ALUResultModel[]:=Block[{param,readFromRam,aluResult,a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8,m1,m2,m3,m4,m5,m6,m7,m8},
...
RegisterBModel[]:=Block[{param,readFromRam,registerB,a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8,m1,m2,m3,m4,m5,m6,m7,m8},
WriteBit8Register[{a1,a2,a3,a4,a5,a6,a7,a8},"InstructionRegister"];
CUDecode[];
WriteBit8Register[{b1,b2,b3,b4,b5,b6,b7,b8},"ParameterRegister"];
WriteBit8AddressBlock[{m1,m2,m3,m4,m5,m6,m7,m8},{b1,b2,b3,b4,b5,b6,b7,b8},"RAM"];
...
CPUModelPlot[model_]:=Block[{instruction,parameter,readFromRam,a1,a2,a3,a4,a5,a6,a7,a8,b1,b2,b3,b4,b5,b6,b7,b8,m1,m2,m3,m4,m5,m6,m7,m8},
...
(* ::Input::Initialization:: *)
ExecuteModel[program_,cycles_]:=Block[{steps,iter = 0},
ClearProgram[];
ALUClear[];
CUClear[];
LoadProgram[program];
