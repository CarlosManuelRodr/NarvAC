...
StyleBox[\"asmcode\",\nFontSlant->\"Italic\"]\)] returns a visualization of the program in a graphical panel.";
PL0Compile::usage ="\!\(\*
StyleBox[\"PL0Compile\",\nFontWeight->\"Bold\"]\)[\!\(\*
...
(* ::Input::Initialization:: *)
NFAStar[nfa_Association] := Block[{minIndex,newM,newTransitions,newAccept,newMachine},
...
NFAToDFA[nfa_Association] := Block[{protoDFA,start,protoDFAStates,newStateRules,newStates,containsAccept,newMachine,newAccept,newStart,newTransitions,newTransitionsCleanedUp,protoDFAExpressionNodes,newStateExpressionsNodes},
